...
<YYINITIAL>{
    ...
    "posicion"      {return symbol(sym.posicion,new String(yytext()));}
    "x"             {return symbol(sym.posicionX,new String(yytext()));}
   "y"             {return symbol(sym.posicionY,new String(yytext()));}
